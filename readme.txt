...
1_data_cleaning.py converts this spreadsheet into a Pandas dataframe, then uses the venue's postcode
to find its latitude and longitiude, add calculates the distance to the nearest station and airport.

2_draw_map.py filters the dataframe according to preference, and generates an interactive map in the
